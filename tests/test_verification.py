...
class AliasEmailVerificationTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.verify_url = reverse('ninjapasswordless:verify_email')
        self.callback_verify = reverse('ninjapasswordless:verify_token')
...
class AliasMobileVerificationTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.callback_url = reverse('ninjapasswordless:auth_token')
        self.verify_url = reverse('ninjapasswordless:verify_mobile')
        self.callback_verify = reverse('ninjapasswordless:verify_token')
